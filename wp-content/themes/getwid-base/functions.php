...
if ( ! function_exists( 'getwid_base_setup' ) ) :
	...
	function getwid_base_setup() {
        ...
        add_theme_support( 'editor-color-palette', array(
            ...
            array(
                'name' => __( 'Light Violet', 'getwid-base' ),
                'slug' => 'light-violet',
                'color' => '#f6eefc',
            ),
            array(
                'name' => __( 'Light Blue', 'getwid-base' ),
                'slug' => 'light-blue',
                'color' => '#f3f8fb',
            ),
            array(
                'name' => __( 'Blue', 'getwid-base' ),
                'slug' => 'blue',
                'color' => '#68c5f9',
            ),
            array(
                'name' => __( 'Gray', 'getwid-base' ),
                'slug' => 'gray',
                'color' => '#9ea6ac',
            ),
            array(
                'name' => __( 'Light Gray', 'getwid-base' ),
                'slug' => 'light-gray',
                'color' => '#f3f9fd',
            ),
            array(
                'name' => __( 'Dark Blue', 'getwid-base' ),
                'slug' => 'dark-blue',
                'color' => '#2c3847',
            ),
